...
Original file is located at
    https://colab.research.google.com/drive/1EUWxIijf_m3qsFrN8oG8I9f5OveD65Y1
...
!gdown --id 1LVF83V20_qL7j9QiPlxhFtu878en7wvn --output "{workspace_dir}/crypko_data.zip"
...
checkpoint_G = torch.load('/content/drive/MyDrive/碩班修課/機器學習/作業/HW6/G_SN20v2.pth')
checkpoint_D = torch.load('/content/drive/MyDrive/碩班修課/機器學習/作業/HW6/D_SN20v2.pth')
...
torch.save({'epoch': n_epoch,
      ...
      }, '/content/drive/MyDrive/碩班修課/機器學習/作業/HW6/G_SN16v3.pth')

torch.save({'epoch': n_epoch,
      'model_state_dict': D.state_dict(),
      'optimizer_state_dict': opt_D.state_dict()
      }, '/content/drive/MyDrive/碩班修課/機器學習/作業/HW6/D_SN16v3.pth')

os.listdir('/content/drive/MyDrive/碩班修課/機器學習/作業/HW6')
